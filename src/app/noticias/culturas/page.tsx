            ...
            <div className={'w-full flex justify-center'}>
                <div className={'w-3/4 mb-20'}>
                    ...
                    <div className="grid grid-cols-3 grid-rows-2 gap-4">
                        <div className={'col-start-1 row-start-1'}><CulturaCard title={'Soja'}
                                                                                image={'/images/graos.jpg'}
                                                                                id={3}/></div>
                        <div className={'col-start-2 row-start-1'}><CulturaCard title={'Milho'}
                                                                                image={'/images/corn.jpg'}
                                                                                id={2}/></div>
                        <div className="col-start-3 row-start-1">
                            <CulturaCard title={'Café'} image={'/images/cafe.jpg'} id={6}/>
                        </div>
                        <div className={'col-start-1 row-start-2'}><CulturaCard title={'Cana-de-Açucar'}
                                                                                image={'/images/cana.jpg'}
                                                                                id={7}/></div>
                        <div className={'col-start-2 row-start-2'}><CulturaCard title={'Bovinos'}
