        ...
        <div>
                        ...
                        <div className="flex flex-col lg:flex-row py-16 gap-8 items-center">
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <LandingPageBtn text="Cadastre-se Agora" href={paths.cadastro()}/>
            ...
            <div
                ...
                <div className={'flex px-12 py-12 h-[40%] flex-col w-[55%] bg-white border rounded-lg shadow-xl'}>
                    ...
                    <div className={'flex flex justify-around gap-4'}>
            ...
            <div className={'flex justify-center gap-2 m-12 mb-20'}>
                <LandingPageBtn text="Fazer Login" href={paths.login()} color={'bg-blue-900'}/>
                <LandingPageBtn text="Cadastre-se" href={paths.cadastro()} color={'bg-blue-900'}/>
            </div>
        </div>
    )
}
